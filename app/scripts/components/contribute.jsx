  ...
  render: function(){
    return(
      <div>
        ...
        <p id="checktextpara">
          <textarea onChange={this.props.onChange} id="checktext" className="text form-control"
          rows="6" defaultValue="Paste your own text here... or check check this text."></textarea>
        </p>
...
// />
// 
// <TinyMCE className="form-control"
        //   content="Hi"
        //   config={{
        //     // mode : "textareas",
        //     plugins : "AtD,paste",
